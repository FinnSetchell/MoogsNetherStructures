...
public final class MNSConditionsRegistry {
    ...
    public static final ResourceKey<Registry<Supplier<Boolean>>> MNS_JSON_CONDITIONS_KEY = ResourceKey.createRegistryKey(new ResourceLocation(MNSCommon.MODID, "json_conditions"));
