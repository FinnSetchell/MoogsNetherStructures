...
import com.finndog.mns.modinit.registry.CustomRegistry;
...
public final class MNSConditionsRegistry {
    private MNSConditionsRegistry() {}

    public static final ResourceKey<Registry<Supplier<Boolean>>> MNS_JSON_CONDITIONS_KEY = ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(MNSCommon.MODID, "json_conditions"));
    public static final CustomRegistry<Supplier<Boolean>> MNS_JSON_CONDITIONS_REGISTRY = CustomRegistry.of(MNSCommon.MODID, MNS_JSON_CONDITIONS_KEY, false, false, true);
    public static final RegistryEntry<Supplier<Boolean>> ALWAYS_TRUE = MNS_JSON_CONDITIONS_REGISTRY.register("always_true", () -> () -> true);
    public static final RegistryEntry<Supplier<Boolean>> ALWAYS_FALSE = MNS_JSON_CONDITIONS_REGISTRY.register("always_false", () -> () -> true);
