...
public class MirroringSingleJigsawPiece extends SinglePoolElement {
    ...
    public MirroringSingleJigsawPiece(SinglePoolElement singleJigsawPiece, Mirror mirror) {
        this(((SinglePoolElementAccessor)singleJigsawPiece).mns_getTemplate(), ((SinglePoolElementAccessor)singleJigsawPiece).mns_getProcessors(), singleJigsawPiece.getProjection(), mirror);
    }
