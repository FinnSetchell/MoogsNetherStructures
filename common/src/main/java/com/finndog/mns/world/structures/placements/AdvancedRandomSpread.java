package com.finndog.mns.world.structures.placements;
...
public class AdvancedRandomSpread extends RandomSpreadStructurePlacement {
    ...
    public AdvancedRandomSpread(Vec3i locationOffset,
        ...
        this.spacing = (int)Math.round(spacing * 1.25);
        this.separation = (int)Math.round(separation * 1.25);
        ...
        if (spacing <= separation) {
            throw new RuntimeException("""
                Moog's Nether Structures: Spacing cannot be less or equal to separation.
    ...
    public StructurePlacementType<?> type() {
        return MNSStructurePlacementType.ADVANCED_RANDOM_SPREAD.get();
    }
