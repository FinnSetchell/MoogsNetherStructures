...
public class MirroringSingleJigsawPiece extends SinglePoolElement {
    ...
    public MirroringSingleJigsawPiece(SinglePoolElement singleJigsawPiece, Mirror mirror) {
        this(((SinglePoolElementAccessor)singleJigsawPiece).mes_getTemplate(), ((SinglePoolElementAccessor)singleJigsawPiece).mes_getProcessors(), singleJigsawPiece.getProjection(), mirror);
    }
