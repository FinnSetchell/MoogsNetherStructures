package com.finndog.mes.mixins.neoforge.structures;
...
public class StructurePoolMixin {
    ...
    private static Codec<Integer> mes_increaseWeightLimit(int minRange, int maxRange, Operation<Codec<Integer>> original) {
