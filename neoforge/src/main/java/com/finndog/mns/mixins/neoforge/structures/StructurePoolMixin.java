package com.finndog.mns.mixins.neoforge.structures;
...
public class StructurePoolMixin {
    ...
    private static Codec<Integer> mns_increaseWeightLimit(int minRange, int maxRange, Operation<Codec<Integer>> original) {
